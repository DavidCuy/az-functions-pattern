...
class BaseService:
    ...
    def multiple_filters(self, session: Session, filters: List[dict], paginate = False, page = 1, per_page = 10, first: bool = False, search_filters: dict = {}):
        return cast(BaseModel, self.model).filters(session, filters, paginate, page, per_page, first, search_filters)
